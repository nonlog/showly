...
- [ ] Perform on-device conflict tests in both directions, including delete-vs-edit, rewatch, rating removal, and remote identity changes. Custom Lists are complete; Watchlist exposed a Trakt-deletion resurrection bug and now has a pre-pass fix awaiting CI/live re-test.
